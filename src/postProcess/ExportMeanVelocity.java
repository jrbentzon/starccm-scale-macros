...
public class ExportMeanVelocity extends StarMacro {
    ...
    public void execute() {
        ...
        createVectorFieldFunction("MeanVelocity", "MeanVelocity",
                "[${MeanVelocity_0Monitor},${MeanVelocity_1Monitor},${MeanVelocity_2Monitor}]", velocity);
        createVelocityVectorScene("Mean Velocity", false, 1);
    }
    ...
    private void createVelocityVectorScene(String name, Boolean recordScene, int frequency) {
        ...
        addFieldFunctionToVectorDisplayer(vectorDisplayer, "MeanVelocity");
        addDerivedPartsToDisplayer(vectorDisplayer, "XZ Plane");
        ...
        String targetPath = String.format("/home/jrb/share/couetteReactive/TransferFolder/MeanVelocity/%s_%s_%s.png",
                name, RPM, RotorName);
