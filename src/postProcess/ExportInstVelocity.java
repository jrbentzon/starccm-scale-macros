...
public class ExportInstVelocity extends StarMacro {

    Simulation simulation;

    public void execute() {
        simulation = getActiveSimulation();
        createVelocityVectorScene("Instantaneous Velocity", false, 1);
    }
    ...
    private void createVelocityVectorScene(String name, Boolean recordScene, int frequency) {
        ...
        addFieldFunctionToVectorDisplayer(vectorDisplayer, "Velocity");
        ...
        String targetPath = String.format("/home/jrb/share/couetteReactive/TransferFolder/InstantaneousVelocity/%s_%s_%s.png", name, RPM,
                RotorName);
