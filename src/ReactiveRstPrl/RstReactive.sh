#wget https://raw.githubusercontent.com/jrbentzon/starccm-scale-thermodynamics/main/src/ReactiveRstPrl/RstReactive.sh
RPM=500
MeshSize=20
FlowRateMlMin=8.3
RotorDiameter=80e-3
...
rm libuser.so
mkdir -p Results
wget https://raw.githubusercontent.com/jrbentzon/starccm-scale-thermodynamics/main/src/ReactiveRstPrl/CouetteReactiveStudyRst.java
wget https://raw.githubusercontent.com/jrbentzon/starccm-scale-thermodynamics/main/src/ReactiveRstPrl/runUnix3.slurm
wget https://raw.githubusercontent.com/jrbentzon/starccm-scale-thermodynamics/main/src/ReactiveRstPrl/runXeon40.slurm
