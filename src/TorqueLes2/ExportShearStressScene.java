...
public class ExportShearStressScene extends StarMacro {

    Simulation simulation;

    public void execute() {
        simulation = getActiveSimulation();
        createShearStressScene("Mean Shaer Stress", false, 1);
    }
    ...
    private void createShearStressScene(String name, Boolean recordScene, int frequency) {
        ...
        addFieldFunctionToScalarDisplayer(scalarDisplayer, "MeanShearStressMonitor");
        addBoundaryToDisplayer(scalarDisplayer, "Stator", "Fluid");

        String RPM = getRpmString();
        String RotorName = getRotorDiameterString();
        String targetPath = String.format("/home/jrb/share/couetteReactive/TransferFolder/Shear/%s_%s_%s.png", name, RPM,
                RotorName);
