...
// Reactive Flow Demo
public class PhiStudyLes extends StarMacro {
        ...
        static final String OUTLETANAME = "OutletA";
        static final String OUTLETBNAME = "OutletB";
        ...
        // Chemistry
        static final boolean isReactive = true;
        ...
        // Time-Stepping 
        static final double INITIALTIMESTEP = 1e-3;
        static final double TARGETCOURANT = 0.8; // adjusting timestep by RPM, RotorDiameter and MeshSize

        // Current Steady/Transient setting
        boolean IsSteady = true;

        // Current Turbulence Model to deactivate before enabling LES
        ...
        public String getFileName() {
                return String.format("PhiTimeSeriesLes_Rotor%s_%s.sim", getRotorDiameterString(), getRpmString());
        }
        ...
        private void RecordOutletConcentrations(String Scalar) {
                ...
                Boundary boundary = region.getBoundaryManager().getBoundary(OUTLETANAME);
        ...
        private void SwapToLes() {
                ...
                implicitUnsteadySolver.getTimeStep().setValue(INITIALTIMESTEP);
