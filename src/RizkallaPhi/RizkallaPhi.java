...
// Reactive Flow Demo
public class RizkallaPhi extends StarMacro {
        ...
        static final double R_fit_pA = 1.03E-4;
        static final double R_fit_pB = 0.00822;
        static final double k1 = 1;
        ...
        public String getFileName() {
                return String.format("Rizkalla_%s_PhiTimeSeriesLes.sim", getRpmString());
        }
        ...
        private void SetWallConcentration(int no, String FieldFunction) {
                ...
                Simulation simulation = getActiveSimulation();
                Region region = simulation.getRegionManager().getRegion(REGIONNAME);
                Boundary boundary = region.getBoundaryManager().getBoundary(WALLNAME);
