...
public class CouetteMixingStudyLes extends StarMacro {
    ...
    public void execute() {
        ...
        StartLesMixingSimulation();

    }

    private void StartLesMixingSimulation() {

        SwapToLes();
        SimName = "Sim_" + TurbulenceModel + "_MIXING_LES_" + uid + ".sim";
        ...
        RunTime(100);
        new StarScript(getActiveRootObject(), new File(resolvePath("RecordTurbulenceChemStats.java"))).play();
        RunTime(0.12);
    ...
    private void RecordOutletConcentrations(String Scalar) {
        ...
        simulation.getMonitorManager().createMonitorAndPlot(new NeoObjectVector(new Object[] { massFlowAverageReport }),
                true, "%1$s Plot");
    ...
    private void setInnerIterationCount(int count) {
        ...
        InnerIterationStoppingCriterion innerIterationStoppingCriterion = ((InnerIterationStoppingCriterion) simulation
                .getSolverStoppingCriterionManager().getSolverStoppingCriterion("Maximum Inner Iterations"));
    ...
    private void SetScalarTurbulentSchmidtNumber(String scalar, double Schmidt) {
        ...
        ConstantMaterialPropertyMethod constantMaterialPropertyMethod = ((ConstantMaterialPropertyMethod) passiveScalarMaterial
                .getMaterialProperties().getMaterialProperty(PassiveScalarTurbulentSchmidtNumberProperty.class)
                .getMethod());
