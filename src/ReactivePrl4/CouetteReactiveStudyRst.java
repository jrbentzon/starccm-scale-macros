...
public class CouetteReactiveStudyRst extends StarMacro {
        ...
        private void StartRstReactiveSimulation() {
                ...
                swapToUnsteady();
                SimName = "Sim_" + TurbulenceModel + "_REACTIVE_RST_PRL_" + uid + ".sim";
                ...
                SetScalarInitialConcentration(0, 2*concentrationNaSO4 * 1 * 0.5);
                SetScalarInitialConcentration(1, 2*concentrationNaSO4 * 2 * 0.5);
                SetScalarInitialConcentration(2, 0*concentrationBaCl2 * 1 * 0.5);
                SetScalarInitialConcentration(3, 0*concentrationBaCl2 * 2 * 0.5);
                InitializeSolution();
